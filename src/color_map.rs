// color_map.rs
use crate::colors::{
    Colors, AQUA, AQUAMARINE1, AQUAMARINE1A, AQUAMARINE3, BLACK, BLUE, BLUE1, BLUE3, BLUE3A,
    BLUEVIOLET, CADETBLUE, CADETBLUEA, CHARTREUSE1, CHARTREUSE2, CHARTREUSE2A, CHARTREUSE3,
    CHARTREUSE3A, CHARTREUSE4, CORNFLOWERBLUE, CORNSILK1, CYAN, CYAN1, CYAN2, DARKBLUE, DARKCYAN,
    DARKGOLDENROD, DARKGREEN, DARKKHAKI, DARKMAGENTA, DARKMAGENTAA, DARKOLIVEGREEN1,
    DARKOLIVEGREEN1A, DARKOLIVEGREEN2, DARKOLIVEGREEN3, DARKOLIVEGREEN3A, DARKOLIVEGREEN3B,
    DARKORANGE, DARKORANGE3, DARKORANGE3A, DARKRED, DARKREDA, DARKSEAGREEN, DARKSEAGREEN1,
    DARKSEAGREEN1A, DARKSEAGREEN2, DARKSEAGREEN2A, DARKSEAGREEN3, DARKSEAGREEN3A, DARKSEAGREEN4,
    DARKSEAGREEN4A, DARKSLATEGRAY1, DARKSLATEGRAY2, DARKSLATEGRAY3, DARKTURQUOISE, DARKVIOLET,
    DARKVIOLETA, DEEPPINK1, DEEPPINK1A, DEEPPINK2, DEEPPINK3, DEEPPINK3A, DEEPPINK4, DEEPPINK4A,
    DEEPPINK4B, DEEPSKYBLUE1, DEEPSKYBLUE2, DEEPSKYBLUE3, DEEPSKYBLUE3A, DEEPSKYBLUE4,
    DEEPSKYBLUE4A, DEEPSKYBLUE4B, DODGERBLUE1, DODGERBLUE2, DODGERBLUE3, FUCHSIA, GOLD1, GOLD3,
    GOLD3A, GREEN, GREEN1, GREEN3, GREEN3A, GREEN4, GREENYELLOW, GREY, GREY0, GREY100, GREY11,
    GREY15, GREY19, GREY23, GREY27, GREY3, GREY30, GREY35, GREY37, GREY39, GREY42, GREY46, GREY50,
    GREY53, GREY54, GREY58, GREY62, GREY63, GREY66, GREY69, GREY7, GREY70, GREY74, GREY78, GREY82,
    GREY84, GREY85, GREY89, GREY93, HONEYDEW2, HOTPINK, HOTPINK2, HOTPINK3, HOTPINK3A, HOTPINKA,
    INDIANRED, INDIANRED1, INDIANRED1A, INDIANREDA, KHAKI1, KHAKI3, LIGHTCORAL, LIGHTCYAN1,
    LIGHTCYAN3, LIGHTGOLDENROD1, LIGHTGOLDENROD2, LIGHTGOLDENROD2A, LIGHTGOLDENROD2B,
    LIGHTGOLDENROD3, LIGHTGREEN, LIGHTGREENA, LIGHTPINK1, LIGHTPINK3, LIGHTPINK4, LIGHTSALMON1,
    LIGHTSALMON3, LIGHTSALMON3A, LIGHTSEAGREEN, LIGHTSKYBLUE1, LIGHTSKYBLUE3, LIGHTSKYBLUE3A,
    LIGHTSLATEBLUE, LIGHTSLATEGREY, LIGHTSTEELBLUE, LIGHTSTEELBLUE1, LIGHTSTEELBLUE3, LIGHTYELLOW,
    LIME, MAGENTA, MAGENTA1, MAGENTA2, MAGENTA3, MAGENTA3A, MAGENTA3B, MAROON, MEDIUMORCHID,
    MEDIUMORCHID1, MEDIUMORCHID1A, MEDIUMORCHID3, MEDIUMPURPLE, MEDIUMPURPLE1, MEDIUMPURPLE2,
    MEDIUMPURPLE2A, MEDIUMPURPLE3, MEDIUMPURPLE3A, MEDIUMPURPLE4, MEDIUMSPRINGGREEN,
    MEDIUMTURQUOISE, MEDIUMVIOLETRED, MISTYROSE1, MISTYROSE3, NAVAJOWHITE1, NAVAJOWHITE3, NAVY,
    NAVYBLUE, NORMAL, OLIVE, ORANGE, ORANGE1, ORANGE2, ORANGE3, ORANGERED1, ORCHID, ORCHID1,
    ORCHID2, PALEGREEN1, PALEGREEN1A, PALEGREEN3, PALEGREEN3A, PALETURQUOISE1, PALETURQUOISE4,
    PALEVIOLETRED1, PINK1, PINK3, PLUM1, PLUM2, PLUM3, PLUM4, PURPLE, PURPLE3, PURPLE4, PURPLE4A,
    PURPLEA, PURPLEB, RED, RED1, RED3, RED3A, ROSYBROWN, ROYALBLUE1, SALMON1, SANDYBROWN,
    SEAGREEN1, SEAGREEN1A, SEAGREEN2, SEAGREEN3, SILVER, SKYBLUE1, SKYBLUE2, SKYBLUE3, SLATEBLUE1,
    SLATEBLUE3, SLATEBLUE3A, SPRINGGREEN1, SPRINGGREEN2, SPRINGGREEN2A, SPRINGGREEN3,
    SPRINGGREEN3A, SPRINGGREEN4, STEELBLUE, STEELBLUE1, STEELBLUE1A, STEELBLUE3, TAN, TEAL,
    THISTLE1, THISTLE3, TURQUOISE2, TURQUOISE4, VIOLET, WHEAT1, WHEAT4, WHITE, YELLOW, YELLOW1,
    YELLOW2, YELLOW3, YELLOW3A, YELLOW4, YELLOW4A,
};
